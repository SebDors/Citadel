...
export const THEMES: Record<ThemeId, ThemeDefinition> = {
  ...
  cyber: {
    id: 'cyber',
    name: 'Cyber-Athletic',
    subtitle: 'Onyx & Vert Athlétique',
    description: 'High-tech de la performance pure (Whoop, Gymshark). Focus mental et contraste optimal.',
    previewColors: {
      dark: ['#0B0E14', '#161B26', '#22C55E', '#FFFFFF'],
